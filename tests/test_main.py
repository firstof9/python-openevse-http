...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 220), ("test_charger_v2", 220)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 2), ("test_charger_v2", 2)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 240), ("test_charger_v2", 240)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", False), ("test_charger_v2", False)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 1), ("test_charger_v2", 0)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 246), ("test_charger_v2", 8751)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", -61), ("test_charger_v2", -56)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 32.2), ("test_charger_v2", 0)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 48), ("test_charger_v2", 25)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 50.3), ("test_charger_v2", 34.0)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 50.3), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", None), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 56.0), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", None), ("test_charger_v2", "4.0.1")],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 6), ("test_charger_v2", 6)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 48), ("test_charger_v2", 48)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 0), ("test_charger_v2", 1)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", "1234567890AB"), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 2299), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 4000), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 75), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", 468), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger", "fast"), ("test_charger_v2", "fast")],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger_new", 48), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger_new", 0), ("test_charger_v2", 0)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger_new", 0), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger_new", 1208725), ("test_charger_v2", None)],
    indirect=["charger"],
)
...
@pytest.mark.parametrize(
    "charger, expected",
    [("test_charger_new", 167436), ("test_charger_v2", None)],
    indirect=["charger"],
)
